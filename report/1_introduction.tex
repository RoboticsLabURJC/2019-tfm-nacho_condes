...
\label{sec:1_sota}
	...
	The problem to be addressed is to \textit{get a robot to follow a person}. This problem can be split into several steps, where different approaches have been previously proposed. These steps will be covered in the following subsections.
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.85\linewidth]{personfollowing_summary}
...
\label{sec:1_objectives}
	...
	\begin{enumerate}
		\item Implement a real-time following behavioral using embedded low-power hardware and a low-complexity educational robot.
