...
The inference times for the fastest SSD-based model and the Tiny YOLOv3 implementations are shown below, and the rest can be found in \autoref{chap:annexes}.
